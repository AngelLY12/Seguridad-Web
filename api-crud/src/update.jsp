        ...
        <form action="${pageContext.request.contextPath}/UpdateController" method="POST" class="bg-white shadow-md rounded-lg p-6">
            <div class="space-y-6">
                ...
                <div class="text-right">
                    ...
                    <a href="/api-crud/SelectController" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                    >
                        Cancelar
                    </a>
                </div>
